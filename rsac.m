...
% Loop over different phase velocities 
for i = 0:10 
% time lag between 2 stations for this phase velocity 
% (hint: time lag = dist/Vphase ~ 1 line) 

% get the shifted seismic trace using the lag 
